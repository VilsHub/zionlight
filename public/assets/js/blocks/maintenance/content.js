...
function maintenanceCountDown(){
	var DateLine = $$.ss("#countDown").innerHTML;
...
//////// grid border rectangle  ///////////
  //gets canvas element
	var TargetCanvas = $$.ss("#canvas");
	var GridBorderRectangleObj = new CShapes();
